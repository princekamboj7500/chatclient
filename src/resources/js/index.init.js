/*
    Template Name: Chatvia - The Laravel Chat Application With Pusher
    Author: Themesbrand
    Version: 1.0.0
...
(function ($) {
  ...
  var pusher = new Pusher("6c6598d9c27d4b0b7510", {
    cluster: "ap2",
    forceTLS: true
  });
  ...
  */
  ...
  $(document).on("click", "#profile-tab", function () {
    const profileTab = document.querySelector('a[data-bs-target="#pills-user"]')
    profileTab.click()
  });


  $(document).on("click", "#setting-tab", function () {
    const settingTab = document.querySelector('a[data-bs-target="#pills-setting"]')
    settingTab.click()
  });
  ...
  */
  ...
  $(document).on("keydown", ".group-chat-input .emoji-wysiwyg-editor", function (event) {
    if (event.which == 13) {
      $(".emoji-wysiwyg-editor").trigger("blur");
      $(".send-group-message").trigger('click');
    }
  });
  ...
  function speechRecognition() {
    if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
      ...
      recognition.onresult = (event) => {
        ...
        var chatInput = document.querySelector(".emoji-wysiwyg-editor");
        console.log(chatInput);
        chatInput.innerHTML = result;
      };
      ...
      startButton.addEventListener('click', () => {
        ...
        navigator.mediaDevices.getUserMedia({ audio: true })
          .then((stream) => {
            ...
            recognition.start();
            startButton.children[0].classList.add("text-danger");
          })
          .catch((error) => {
      ...
      recognition.onend = () => {
        startButton.children[0].classList.remove("text-danger");
      };
