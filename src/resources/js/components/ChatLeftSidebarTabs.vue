            ...
            <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                ...
                <div>
                    ...
                    <div class="text-center p-4 border-bottom">
                        <div class="mb-4">
                            <img :src="this.$store.state.LeftTabsData.AuthUser.avatar" class="rounded-circle avatar-lg img-thumbnail imgavatar" alt="">
                        </div>

                        <h5 class="font-size-16 mb-1 text-truncate profile-newname">{{ this.$store.state.LeftTabsData.AuthUser.name }}</h5>
                        ...
                        <div id="profile-user-accordion-1" class="custom-accordion">
                                ...
                                <div id="profile-user-collapseOne" class="collapse show"
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <h5 class="font-size-14 profile-newname text-truncate">{{ this.$store.state.LeftTabsData.AuthUser.name }}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="text-muted mb-1">Email</p>
                                            <h5 class="font-size-14">{{ this.$store.state.LeftTabsData.AuthUser.email }}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="text-muted mb-1">Time</p>
                                            <h5 class="font-size-14">{{ this.$store.state.LeftTabsData.AuthUser.created_at }}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="text-muted mb-1">Location</p>
                                            <h5 class="font-size-14 mb-0">{{ this.$store.state.LeftTabsData.AuthUser.location }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-1 shadow-none border">
                                ...
                                <div id="profile-user-collapseTwo" class="collapse" aria-labelledby="profile-user-headingTwo" data-parent="#profile-user-accordion-1">
                                    <div class="card-body">
                                        <div v-for="(message, index) in this.$store.state.LeftTabsData.AttachedFiles" :key="index">
                ...
                <div>
                    ...
                    <div class="px-4 pb-4" dir="ltr">
                        ...
                        <div class="owl-carousel owl-theme owl-loaded owl-drag" id="user-status-carousel">
                            ...
                            <div class="owl-stage-outer" v-for="(user, index) in this.$store.state.LeftTabsData.users" :key="index">
                        ...
                        <div class="chat-message-list px-2" data-simplebar>
                            <div class="chat-message-chatlist">
                                <ul class="list-unstyled chat-list chat-user-list">
                                    <div v-for="(user, index) in this.$store.state.LeftTabsData.users" :key="index">
                                                    ...
                                                    <div class="card border">
                                                        ...
                                                        <div class="card-body p-2 overflow-hidden overflow-scroll">
                                                            <div data-simplebar style="max-height: 150px;">
                                                                <div v-for="(contactsArray, key) in this.$store.state.LeftTabsData.contacts" :key="key">
                    ...
                    <div class="p-4 chat-message-list chat-group-list" data-simplebar="init">
                        <div id="chat-group-list">
                            <ul class="list-unstyled chat-list">
                                <div v-for="(group, index) in this.$store.state.LeftTabsData.groupdata" :key="index">
                ...
                <div>
                    ...
                    <div class="text-center border-bottom p-4">
                        <div class="mb-4 profile-user">
                            ...
                            <img id="imgAvatar" :src="this.$store.state.LeftTabsData.AuthUser.avatar"
                        ...
                        <h5 id="user-profile-name" class="font-size-16 mb-1 text-truncate profile-newname">{{ this.$store.state.LeftTabsData.AuthUser.name }}</h5>
                            ...
                            <div class="card shadow-none border mb-2">
                                ...
                                <div id="profile-setting-personalinfocollapse" class="collapse show"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <p class="text-muted mb-1">Name</p>
                                            <h5 id="profile-newname" class="font-size-14 profile-newname text-truncate">{{ this.$store.state.LeftTabsData.AuthUser.name }}</h5>
                                            <div class="d-flex justify-content-between">
                                                <input type="text" class="form-control bg-light-subtle border-light" v-model="this.$store.state.LeftTabsData.AuthUser.name"
...
import { mapActions } from 'vuex';
    export default {
        ...
        mounted() {
            ...
            console.log("AuthUser in leftsidetabcomponent:", this.$store.state.LeftTabsData.AuthUser);
            console.log("AttachedFiles in leftsidetabcomponent:", this.$store.state.LeftTabsData.AttachedFiles);
            console.log("users in leftsidetabcomponent:", this.$store.state.LeftTabsData.users);
            console.log("contacts in leftsidetabcomponent:", this.$store.state.LeftTabsData.contacts);
            console.log("groupdata in leftsidetabcomponent:", this.$store.state.LeftTabsData.groupdata);
        },
        methods: {
            ...mapActions({
